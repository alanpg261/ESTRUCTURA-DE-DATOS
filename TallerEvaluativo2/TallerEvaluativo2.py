...
#ESTA FUNCIÓN RECOGE LOS DATOS DE LOS PRODUCTOS SEGUN LA CANTIDAD DE PRODUCTOS A REGISTRAR, 
#CON VALIDACIONES DE ENTRADA PARA CADA DATO INGRESADO, Y LOS ALMACENA EN LISTAS SEPARADAS PARA CADA ATRIBUTO DEL PRODUCTO
...
#LA FUNCIÓN RECIBE LAS LISTAS DE PRECIOS Y CANTIDADES, ASÍ COMO LA CANTIDAD DE PRODUCTOS REGISTRADOS,
#Y CALCULA EL VALOR TOTAL DEL INVENTARIO MULTIPLICANDO EL PRECIO POR LA CANTIDAD DE CADA PRODUCTO Y SUMANDO LOS RESULTADOS.
...
#LA FUNCIÓN RECIBE LAS LISTAS DE ATRIBUTOS DE LOS PRODUCTOS Y LA CANTIDAD DE PRODUCTOS REGISTRADOS,
#Y MUESTRA UN RESUMEN DEL INVENTARIO CON LOS DATOS DE CADA MEDICAMENTO, 
#INCLUYENDO UNA ALERTA DE STOCK CRÍTICO SI LA CANTIDAD EN STOCK ES MENOR A 5 UNIDADES.
...
#FUNCION MAIN QUE MUESTRA UN MENÚ PRINCIPAL PARA SELECCIONAR LAS DIFERENTES FUNCIONES DEL SISTEMA DE GESTIÓN DE DROGUERÍA;
#CON VALIDACIONES DE ENTRADA PARA SELECCIONAR UNA OPCIÓN VÁLIDA, Y EJECUTA LA FUNCION CORRESPONDIENTE SEGÚN LA OPCIÓN ELEGIDA; 
